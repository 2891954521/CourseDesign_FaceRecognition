...
def create_signup_page():
    ...
    def show():
        ...
        print(new_pwd.get())
        print(new_pwd2.get())
        print(invitation_code.get())
        new_name.place_forget()
        new_pwd.place_forget()
        new_pwd2.place_forget()
        invitation_code.place_forget()
    ...
    tk.Button(signup_page,text='注册',command=show).place(x=swidth*22/32,y=sheight*70/100)#注册
