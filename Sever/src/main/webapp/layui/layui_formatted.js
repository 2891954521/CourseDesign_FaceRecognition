...
function(t) {
	...
	a = function() {
		var t = e.currentScript ? e.currentScript.src: function() {
			...
			n = r.length - 1,
			o = n; o > 0; o--) if ("interactive" === r[o].readyState) {
				t = r[o].src;
				break
			}
			return t || r[n].src
	...
	n.prototype.define = function(t, e) {
		...
		return o && (e = t, t = []),
		n.use(t, a, null, "define"),
		n
	},
	n.prototype.use = function(n, o, c, s) {
		function p(t, e) {
			var n = "PLaySTATION 3" === navigator.platform ? /^complete$/: /^(complete|loaded)$/; ("load" === t.type || n.test((t.currentTarget || t.srcElement).readyState)) && (r.modules[h] = e, v.removeChild(b),
			function o() {
		...
		function f() {
			c.push(layui[h]),
			n.length > 1 ? y.use(n.slice(1), o, c, s) : "function" == typeof o &&
			function() {
		...
		t.jQuery && jQuery.fn.on && (y.each(n,
		function(t, e) {
			"jquery" === e && n.splice(t, 1)
		}), layui.jquery = layui.$ = jQuery);
		var h = n[0],
		m = 0;
		if (c = c || [], r.host = r.host || (d.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === n.length || layui["layui.all"] && l[h]) return f(),
		y;
		var g = (l[h] ? d + "modules/": /^\{\/\}/.test(y.modules[h]) ? "": r.base || "") + (y.modules[h] || h) + ".js";
		if (g = g.replace(/^\{\/\}/, ""), !r.modules[h] && layui[h] && (r.modules[h] = g), r.modules[h]) !
		function S() {
			...
			v.appendChild(b),
			!b.attachEvent || b.attachEvent.toString && b.attachEvent.toString().indexOf("[native code") < 0 || u ? b.addEventListener("load",
			function(t) {
				p(t, g)
			},
			!1) : b.attachEvent("onreadystatechange",
			function(t) {
				p(t, g)
			}),
			r.modules[h] = g
	...
	n.prototype.link = function(t, n, o) {
		...
		"function" != typeof n ? a: (function y(o) {
			var u = 100,
...
function(e) {
	...
	n = {
		fixbar: function(e) {
			...
			t("." + r)[0] || ("object" == typeof e.css && g.css(e.css), l.append(g), s(), g.find("li").on("click",
			function() {
				var i = t(this),
				n = i.attr("lay-type");
		...
		toVisibleArea: function(e) {
			...
			e), e.scrollElem[0] && e.thisElem[0]) {
				...
				g = i.offset()[o],
				u = n.offset()[o] - g,
				s = {}; (u > c - e.margin || u < e.margin) && (s[a] = u - c / 2 + l, i.animate(s, e.duration))
			}
		},
...
function(t) {
	...
	s.prototype.tabAdd = function(t, a) {
		...
		function() {
			var t = [];
			return layui.each(a,
			function(i, a) { / ^(title | content) $ / .test(i) || t.push("lay-" + i + '="' + a + '"')
			}),
		...
		s = {
			...
			nav: function() {
				...
				i(o + l).each(function(a) {
					...
					d = l.find("." + r);
					l.find("." + c)[0] || (l.append(o), (l.hasClass(u) ? d.find("dd,>." + m) : d).on("mouseenter",
					function() {
						C.call(this, o, l, a)
					}).on("mouseleave",
					function() {
...
function(e) {
		...
		u = function() {
			...
			function(e, o) {
				...
				"function" == typeof l.progress && (c.xhr = function() {
					...
					return i.upload.addEventListener("progress",
					function(t) {
	...
	e(r, a)
});layui.define(["jquery", "laytpl", "lay"],
function(e) {
	"use strict";
	var i = layui.$,
	n = layui.laytpl,
	...
	k.prototype.init = function(e) {
		...
		t = n.config,
		a = t.elem = i(t.elem);
		if (a.length > 1) return layui.each(a,
		function() {
			u.render(i.extend({},
			t, {
				elem: this
	...
	k.prototype.render = function(e) {
		...
		c = ['<div class="layui-dropdown layui-border-box layui-panel layui-anim layui-anim-downbit">', "</div>"].join(""); ("contextmenu" === a.trigger || lay.isTopElem(a.elem[0])) && (e = !0),
		!e && a.elem.data(o + "_opened") || (t.elemView = i(c), t.elemView.append(a.content || s()), a.className && t.elemView.addClass(a.className), a.style && t.elemView.attr("style", a.style), u.thisId = a.id, t.remove(), r.append(t.elemView), a.elem.data(o + "_opened", !0), t.position(), d.prevElem = t.elemView, d.prevElem.data("prevElem", a.elem), t.elemView.find(".layui-menu").on(l,
		function(e) {
			layui.stope(e)
		}), t.elemView.find(".layui-menu li").on("click",
		function(e) {
			var n = i(this),
			l = n.data("item") || {},
			r = l.child && l.child.length > 0;
			r || "-" === l.type || (t.remove(), "function" == typeof a.click && a.click(l, n))
		}), t.elemView.find(V).on("click",
		function(e) {
			var n = i(this),
			t = n.parent(),
			l = t.data("item") || {};
			"group" === l.type && a.isAllowSpread && d.spread(t)
		}), "mouseenter" === a.trigger && t.elemView.on("mouseenter",
		function() {
	...
	k.prototype.events = function() {
		...
		"mouseenter" === i.trigger && i.elem.on("mouseleave",
		function() {
			e.delayRemove()
		})
	},
	...
	function() {
		...
		function(e) {
			if (u.thisId) {
				...
				if (i) {
					var n = i.config; ! lay.isTopElem(n.elem[0]) && "contextmenu" !== n.trigger && (e.target === n.elem[0] || n.elem.find(e.target)[0] || e.target === i.elemView[0] || i.elemView && i.elemView.find(e.target)[0]) || i.remove()
				}
			}
		});
...
function(e) {
	...
	I.prototype.pullData = function(e) {
		...
		if (i.startTime = (new Date).getTime(), a.url) {
			...
			"object" == typeof a.totalRow && (d[n.totalRowName] = t.extend({},
			a.totalRow)),
	...
	I.prototype.renderData = function(e, n, o, r) {
		...
		b = function() {
			var e;
			return ! r && d.sortKey ? d.sort(d.sortKey.field, d.sortKey.sort, !0) : (layui.each(y,
			function(a, l) {
				var o = [],
				y = [],
				h = [],
				...
				"array" === layui._typeof(l) && 0 === l.length || (r || (l[c.config.indexName] = a), d.eachCols(function(n, r) {
					...
					if (void 0 !== m && null !== m || (m = ""), !r.colGroup) {
						var g = ['<td data-field="' + d + '" data-key="' + v + '" ' +
						function() {
							var e = [];
		...
		return c.cache[d.key] = y,
		d.layPage[0 == o || 0 === y.length && 1 == n ? "addClass": "removeClass"](f),
		0 === y.length ? (d.renderForm(), d.errorView(s.text.none)) : (d.layFixed.removeClass(f), r ? b() : (b(), d.renderTotal(y, h), void(s.page && (s.page = t.extend({
	...
	I.prototype.renderTotal = function(e, a) {
		...
		if (n.totalRow) {
			...
			l.eachCols(function(e, c) {
				...
				y = ['<td data-field="' + d + '" data-key="' + n.index + "-" + c.key + '" ' +
				function() {
					var e = [];
	...
	I.prototype.sort = function(e, i, a, l) {
		...
		u.autoSort && ("asc" === i ? r = layui.sort(f, n) : "desc" === i ? r = layui.sort(f, n, !0) : (r = layui.sort(f, c.config.indexName), delete d.sortKey)),
...
function(a) {
	...
	function(a) {
		...
		layui.each(l.reverse(),
		function(l, i) {
			var t = e(i),
			c = t.html(); (t.attr("lay-encode") || a.encode) && (c = c.replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;")),
